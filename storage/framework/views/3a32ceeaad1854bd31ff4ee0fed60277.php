...
<?php endif; ?>
            ...
            <form
                action="<?php echo e(filament()->getProfileUrl()); ?>"
                method="get"
                class="my-auto"
            >
                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'gray','icon' => 'heroicon-m-user-circle','labeledFrom' => 'sm','tag' => 'button','type' => 'submit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','icon' => 'heroicon-m-user-circle','labeled-from' => 'sm','tag' => 'button','type' => 'submit']); ?>
...
<?php endif; ?>
<?php /**PATH /home/sajad/Laravel/API-Community-Platform/vendor/filament/filament/src/../resources/views/widgets/account-widget.blade.php ENDPATH**/ ?>