...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['href' => 'http://localhost:3000','tag' => 'a','color' => 'warning','icon' => 'heroicon-m-home']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => 'http://localhost:3000','tag' => 'a','color' => 'warning','icon' => 'heroicon-m-home']); ?>
            Back Home
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/sajad/Laravel/API-Community-Platform/resources/views/filament/pages/auth/login-custom.blade.php ENDPATH**/ ?>